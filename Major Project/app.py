...
model_path = os.path.join(r"/Users/bhushannimje/Documents/Company/Scifor Technologies/Major Project/Pneumonia Detection from Chest X-Rays Using Deep Learning/Pneumonia Detection.keras")
